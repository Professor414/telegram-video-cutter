...
async def handle_video(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("✅ បានទទួលវីដេអូ។
សូមវាយ /split <នាទី> ដើម្បីកាត់វា។")
...
async def split_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        await update.message.reply_text("❌ ប្រើត្រឹមត្រូវ: /split <នាទី>")
        return
    ...
    await update.message.reply_text("✂️ กំពុងកាត់វីដេអូ...")
